...
//show user list
exports.user_list = (req,res) => {res.send('should be a user list')}

//show user_create form by get
exports.user_create_get = (req,res) => {res.send('should be a user create form ')}
...
exports.user_update_get = (req,res) => {res.send('should be user update form')}
